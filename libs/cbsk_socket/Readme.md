...
```toml
fast_log = "1.6.16"
cbsk_base = { version = "1.1.0" }
cbsk_socket = { version = "1.1.0", features = ["tcp_server"] }
```
...
```toml
fast_log = "1.6.16"
cbsk_base = { version = "1.1.0", features = ["async-trait"] }
cbsk_socket = { version = "1.1.0", features = ["tcp_client"] }
```
