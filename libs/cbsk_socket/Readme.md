...
```toml
fast_log = "1.6.16"
cbsk_base = { version = "1.3.8" }
cbsk_socket = { version = "1.3.8", features = ["tcp_server"] }
```
...
```toml
fast_log = "1.6.16"
cbsk_base = { version = "1.3.8", features = ["async-trait"] }
cbsk_socket = { version = "1.3.8", features = ["tcp_client"] }
```
