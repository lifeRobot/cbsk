...
| [anyhow](https://crates.io/crates/anyhow)                   | [github](https://github.com/dtolnay/anyhow)         | 1.0.77  |
...
```toml
cbsk_base = { version = "0.1.4", features = ["serde_derive_json"] }
```
...
```toml
cbsk_base = { version = "0.1.4", features = ["macro", "anyhow"] }
```
...
```toml
cbsk_base = { version = "0.1.4", features = ["root_path"] }
```
