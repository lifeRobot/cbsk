...
| [serde](https://crates.io/crates/serde)                     | [github](https://github.com/serde-rs/serde)         | 1.0.209 |
| [serde_json](https://crates.io/crates/serde_json)           | [github](https://github.com/serde-rs/json)          | 1.0.127 |
...
```toml
cbsk_base = { version = "2.0.2", features = ["serde_derive_json"] }
```
...
```toml
cbsk_base = { version = "2.0.2", features = ["macro", "anyhow"] }
```
...
```toml
cbsk_base = { version = "2.0.2", features = ["root_path"] }
```
