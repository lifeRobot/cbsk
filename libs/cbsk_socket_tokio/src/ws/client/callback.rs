...
pub trait WsClientCallBack: Send + Sync + 'static {
    ...
    fn recv_text(&self, text: Utf8Bytes) -> impl Future<Output = ()> + Send;
    ...
    fn recv_binary(&self, binary: Bytes) -> impl Future<Output = ()> + Send {
    ...
    fn recv_ping(&self, ping: Bytes) -> impl Future<Output = ()> + Send {
    ...
    fn recv_pong(&self, pong: Bytes) -> impl Future<Output = ()> + Send {
